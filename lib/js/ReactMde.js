...
var ReactMde = /** @class */ (function (_super) {
    ...
    ReactMde.prototype.render = function () {
        ...
        var _a = this.props, commands = _a.commands, layoutOptions = _a.layoutOptions, className = _a.className, emptyPreviewHtml = _a.emptyPreviewHtml, readOnly = _a.readOnly;
        ...
        return (React.createElement("div", { className: "react-mde " + (className || "") },
            React.createElement(Layout, { onChange: this.handleDraftStateChange, onCommand: this.onCommand, commands: commands, layoutOptions: layoutOptions, mdeEditorState: editorState, emptyPreviewHtml: emptyPreviewHtml, readOnly: readOnly })));
    };
