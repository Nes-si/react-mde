...
var VerticalLayout = /** @class */ (function (_super) {
    ...
    VerticalLayout.prototype.render = function () {
        var _this = this;
        var _a = this.props, commands = _a.commands, mdeEditorState = _a.mdeEditorState, layoutOptions = _a.layoutOptions, emptyPreviewHtml = _a.emptyPreviewHtml, readOnly = _a.readOnly;
        ...
        return (React.createElement("div", { className: "react-mde-vertical-layout" },
            React.createElement(components_1.MdeToolbar, { commands: commands, onCommand: this.handleCommand, readOnly: readOnly }, finalLayoutOptions.displayToggleButtons && React.createElement("div", { className: "mde-tabs" },
            ...
            React.createElement("div", { className: "react-mde-content" },
                this.state.showCode &&
                    React.createElement(components_1.MdeEditor, { className: classNames({
                            "mde-text-only": !this.state.showPreview,
                        }, finalLayoutOptions.editorClassName), editorRef: function (c) { return _this.editorRef = c; }, onChange: this.handleMdeStateChange, editorState: mdeEditorState, readOnly: readOnly }),
                this.state.showPreview &&
                    React.createElement(components_1.MdePreview, { className: classNames({
                            "mde-preview-only": !this.state.showCode,
                        }, finalLayoutOptions.previewClassName), previewRef: function (c) { return _this.previewRef = c; }, html: mdeEditorState ? mdeEditorState.html : "", emptyPreviewHtml: emptyPreviewHtml }))));
    };
