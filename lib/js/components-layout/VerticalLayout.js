            ...
            React.createElement("div", { className: "react-mde-content" },
                this.state.showCode &&
                    React.createElement(components_1.MdeEditor, { className: classNames({
                        ...
                        }, finalLayoutOptions.editorClassName), editorRef: function (c) { return _this.editorRef = c; }, onChange: this.handleMdeStateChange, editorState: mdeEditorState }),
                this.state.showPreview &&
                    React.createElement(components_1.MdePreview, { className: classNames({
                            "mde-preview-only": !this.state.showCode,
                        }, finalLayoutOptions.previewClassName), previewRef: function (c) { return _this.previewRef = c; }, html: mdeEditorState ? mdeEditorState.html : "" }))));
    };
